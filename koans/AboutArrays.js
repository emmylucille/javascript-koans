describe("About Arrays", function() {
  ...
  it("should create arrays", function() {
    ...
    expect(multiTypeArray[4]["value2"]).toBe(5); //I don't understand why?
  ...
  it("should understand array length", function () {
    ...
    expect(tenEmptyElementArray.length).toBe(false);
  });
  ...
  it("should know about shifting arrays", function () {
    ...
    expect(shiftedValue).toEqual(null);
    expect(array).toEqual([null, 3, 1, 2]);
  });
});
